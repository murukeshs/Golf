    ...
    public class SmsNotification
    {
        public static SMSResponse SendMessage(string to, string text) //List<Attachments> attachments, string body, string cc,
        {
            try
            {
                ...
                {
                    from = "9999999999",     //"19565390371"           //Configuration.Instance.Settings["appsettings:NEXMO_FROM_NUMBER"],
                    to = to,                //"+14087224019"
                    text = text
                });
        ...
        public static SMSResponse SendMessageNotification(string to, string text) //List<Attachments> attachments, string body, string cc,
        {
